...
function UpdateListing() {
    ...
    const handleSubmit = async (evt) => {
        ...
        try {
            ...
            const response = await fetch(`https://ga-p4-backend.onrender.com/listing/update/${listingId}`, {
                method: 'POST',
                credentials: 'include',
                headers: {
  ...
  return (
    <main>
        <h1 className='text-3xl font-bold text-center mt-4'>Update listing</h1>
