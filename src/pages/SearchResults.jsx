...
function SearchResults() {
    ...
    useEffect(() => {
        ...
        const fetchListings = async () => {
            ...
            const response = await fetch(`https://ga-p4-backend.onrender.com/listing/getAll?${searchQuery}`);
    ...
    <div className=' flex flex-row mt-4 ml-4'>
        ...
        <div>
            ...
            <div className='flex flex-wrap'>
                {listings.length === 0 && (<p className='text-xl mt-2'>No listings found.</p>)}
